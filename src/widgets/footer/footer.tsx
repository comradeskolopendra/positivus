        ...
        <footer className={styles.footer}>
            ...
            <section className={styles.middle}>
                <div className={styles.contactUs}>
                    <Title size="s" variant="primary" className={styles.title}>Contact us:</Title>
                ...
                <form className={styles.email}>
                    ...
                    <Button variant="primary" type="submit" className={styles.subscribe}>Subscribe to news</Button>
                </form>
            </section>
